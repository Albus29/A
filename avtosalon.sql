...
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (1, 'Генеральный Директор');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (2, 'Заместитель генерального директора');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (3, 'Главный бухгалтер');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (4, 'Бухгалтер');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (5, 'Младший бухгалтер');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (6, 'Помощник бухгалтера');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (7, 'Секретарь');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (8, 'Помощник секреторя');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (9, 'Помощник генерального директора');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (10, 'Помощник заместителя генерального директора');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (11, 'Программист');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (12, 'Главнй программист');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (13, 'Кассир');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (14, 'Главный менеджер');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (15, 'Менеджер');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (16, 'Главный механик');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (17, 'Механик');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (18, 'Электрик');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (19, 'Сантехник');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (20, 'Уборщик');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (21, 'Юрист');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (22, 'Экономист');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (23, 'Менеджер по рекламе');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (24, 'Охранник');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (25, 'Менеджер по продажам');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (26, 'Администратор аавтосалона');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (27, 'Главный кассир');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (28, 'Специалист по страхованию автомобиля');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (29, 'Кредитный эксперт');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (30, 'Водитель');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (31, 'Старший кредитный эксперт');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (32, 'Логист');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (33, 'Автомойщик');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (34, 'Менеджер по запасным частям');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (35, 'Продавец-консультант');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (36, 'Мастер-приемщик');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (37, 'Кузовщик');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (38, 'Менеджер по выкупу автомобилей с пробегом');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (39, 'Руководитель в грузовой автосервис');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (40, 'Руководитель в легковой автосервис');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (41, 'Ведущий специалист по выкупу автомобилей с пробегом');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (42, 'Дворник');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (43, 'Уборщик производственных и служебных помещений');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (44, 'Шиномонтажник');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (45, 'Ассистент');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (46, 'Главный менеджер по работе с клиентом');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (47, 'Менеджер по работе с клиентом');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (48, 'Бариста');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (49, 'Автоарматурщик ');
INSERT INTO `job_title` (`id_job_title`, `name`) VALUES (50, 'Детейлер');
